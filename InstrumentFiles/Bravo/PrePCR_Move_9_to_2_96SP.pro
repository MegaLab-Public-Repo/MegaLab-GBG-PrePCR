...
<Velocity11 file='Protocol_Data' md5sum='d5e9cf3fc2626381325c3294a5ff06e7' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Define Variables' bOnlyFirstTime='0' bPromptWhenExecuted='0' strPromptText='' >
					...
					<arrVariables EndLocation='2' StartLocation='9' />
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Device to use' Value='PrePCR_BravoST' />
						<Parameter Category='' Name='Location to use' TaskParameterScript='=EndLocation' Value='2' />
					</Parameters>
				</Task>
