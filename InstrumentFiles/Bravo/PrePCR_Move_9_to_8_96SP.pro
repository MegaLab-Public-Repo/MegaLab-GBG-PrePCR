...
<Velocity11 file='Protocol_Data' md5sum='ad1ba049d82997ba4611ffc6a5b87e49' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Define Variables' bOnlyFirstTime='0' bPromptWhenExecuted='0' strPromptText='' >
					...
					<arrVariables EndLocation='8' StartLocation='9' />
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Device to use' Value='PrePCR_BravoST' />
						<Parameter Category='' Name='Location to use' TaskParameterScript='=EndLocation' Value='8' />
					</Parameters>
				</Task>
