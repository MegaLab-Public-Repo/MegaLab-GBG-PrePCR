...
<Velocity11 file='Protocol_Data' md5sum='1a7b4e28113db68beeb60562c876c0ea' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='Disabled' AutoUnloadRacks='1' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\MegaLab-GBG-PrePCR\InstrumentFiles\Bravo\PrePCR_BC4R_Bravo96ST.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='0' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Define Variables' bOnlyFirstTime='0' bPromptWhenExecuted='0' strPromptText='' >
					...
					<arrVariables EndLocation='4' StartLocation='2' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location to use' TaskParameterScript='=StartLocation' Value='2' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
			...
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Move Safe' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Move Safe' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Pipette_Process Name='Move Safe' >
				<Minimized >0</Minimized>
