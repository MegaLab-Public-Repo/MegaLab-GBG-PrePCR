...
<Velocity11 file='Protocol_Data' md5sum='220e640fe009978a52afd5ef52c19e49' version='2.0' >
		...
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Define Variables' bOnlyFirstTime='0' bPromptWhenExecuted='0' strPromptText='' >
					...
					<arrVariables EndLocation='4' StartLocation='1' />
				</Task>
				<Plate_Parameters >
			...
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location to use' TaskParameterScript='=StartLocation' Value='1' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
