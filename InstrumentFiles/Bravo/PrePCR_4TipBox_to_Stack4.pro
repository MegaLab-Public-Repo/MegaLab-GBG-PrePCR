...
<Velocity11 file='Protocol_Data' md5sum='b76a7d2941c04dbb704615b4e078bd64' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='When the main protocol starts' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\CTS_PrePCR\Device Files\PrePCR_BC4R_Bravo96ST.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='0' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='0' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Downstack' >
					<Devices >
						<Device Device_Name='Agilent BenchCel - 1' Location_Name='Stacker 1' />
						<Device Device_Name='Agilent BenchCel - 1' Location_Name='Stacker 2' />
						<Device Device_Name='Agilent BenchCel - 1' Location_Name='Stacker 3' />
					</Devices>
					<Enable_Backup >0</Enable_Backup>
					<Task_Disabled >0</Task_Disabled>
					<Task_Skipped >0</Task_Skipped>
			...
			<Process >
				...
				<Task Name='BuiltIn::Loop' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Numberoftimestoloop=NumTipBoxes;
' />
					<Parameters >
						<Parameter Category='' Name='Number of times to loop' TaskParameterScript='=NumTipBoxes' Value='8' />
				...
				<Task Name='BuiltIn::Spawn Process' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Process to spawn' Value='Tips' />
