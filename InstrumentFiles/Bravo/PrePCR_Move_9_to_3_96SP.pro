...
<Velocity11 file='Protocol_Data' md5sum='d83d6e315081b5f5bab54058b434b4bc' version='2.0' >
	<File_Info AllowSimultaneousRun='1' AutoExportGanttChart='0' AutoLoadRacks='Disabled' AutoUnloadRacks='0' AutomaticallyLoadFormFile='1' Barcodes_Directory='' ClearInventory='0' DeleteHitpickFiles='1' Description='' Device_File='C:\VWorks Workspace\CTS_PrePCR\Device Files\PrePCR_BC4R_Bravo96ST.dev' Display_User_Task_Descriptions='1' DynamicAssignPlateStorageLoad='1' FinishScript='' Form_File='' HandlePlatesInInstance='1' ImportInventory='0' InventoryFile='' Notes='' PipettePlatesInInstanceOrder='0' Protocol_Alias='' StartScript='' Use_Global_JS_Context='0' />
	<Processes >
		<Startup_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Define Variables' bOnlyFirstTime='0' bPromptWhenExecuted='0' strPromptText='' >
					...
					<arrVariables EndLocation='3' StartLocation='9' />
				</Task>
				<Plate_Parameters >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='BuiltIn::Place Plate' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Location to use' TaskParameterScript='=StartLocation' Value='9' />
					</Parameters>
				</Task>
				<Task Name='BuiltIn::Place Plate' >
					<Devices >
					...
					<Parameters >
						...
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Device to use' Value='PrePCR_BravoST' />
						<Parameter Category='' Name='Location to use' TaskParameterScript='=EndLocation' Value='3' />
					</Parameters>
				</Task>
				<Task Name='Bravo::SubProcess' >
					...
					<Parameters >
						...
						<Parameter Category='Static labware configuration' Name='1' Value='384 V11 Tip Box ST70 19133.002' />
						...
						<Parameter Category='Static labware configuration' Name='8' Value='96 KingFisher 96 KF Plate (200 µl) _97002540' />
			...
			<Process >
				...
				<Plate_Parameters >
					...
					<Parameter Name='Plate type' Value='384 V11 Tip Box ST70 19133.002' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
					<Parameter Name='Use single instance of plate' Value='1' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='PH_Q3' />
					<Parameter Name='Plate type' Value='96 KingFisher 96 KF Plate (200 µl) _97002540' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='MoveToSafe' >
				...
				<Task Name='BuiltIn::Reserve Location' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings />
					<TaskScript Name='TaskScript' Value='task.Locationtouse_location=EndLocation;' />
					<Parameters >
						<Parameter Category='Task Description' Name='Task number' Value='1' />
						<Parameter Category='Task Description' Name='Task description' Value='Reserve Location' />
						<Parameter Category='Task Description' Name='Use default task description' Value='1' />
						<Parameter Category='' Name='Location to use, plate' Value='PlateToMove' />
						<Parameter Category='' Name='Location to use, location' TaskParameterScript='=EndLocation' Value='&lt;auto-select&gt;' />
